...
%Retrieves the function currently being compiled from thread-local storage:
...
%Detects whether a variable appears in head position of any nested expression:
...
%Detects whether a variable appears as a higher-order argument in any nested expression:
